...
Define the builder pattern for constructing multi-memory shared regions with automatic alignment, sealed layout headers, and positional sub-memory discovery.
