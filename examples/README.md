...
- [data-pipeline](data-pipeline): A four-stage pipeline that transforms a stream of integers.
...
- [waf](waf): A Web Application Firewall (WAF) scaffold that demonstrates how to build, route, and transform data pipelines.
